        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            <img
              ...
              className="w-6 h-6"
            />
            <span className="font-light text-2xl tracking-wider bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent transition-all duration-300">
              Abhi
            </span>
          </motion.div>
